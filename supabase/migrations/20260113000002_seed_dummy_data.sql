-- Seed dummy/test data into database
-- This migration adds sample shops, products, customers, sales, etc. for testing

-- Insert dummy shops
INSERT INTO public.shops (id, name, location, phone, email, manager_id) VALUES
  ('10000000-0000-0000-0000-000000000001', 'Main Store', '123 Main Street, Downtown', '+1234567891', 'main@stocksync.com', NULL),
  ('10000000-0000-0000-0000-000000000002', 'Branch Store', '456 Oak Avenue, Uptown', '+1234567892', 'branch@stocksync.com', NULL),
  ('10000000-0000-0000-0000-000000000003', 'Outlet Store', '789 Pine Road, Suburb', '+1234567893', 'outlet@stocksync.com', NULL)
...
-- Insert inventory for shops with realistic stock levels
...
-- Insert dummy sales (Note: User IDs are placeholders - update with actual user IDs after user creation)
INSERT INTO public.sales (id, sale_number, shop_id, customer_id, sales_person_id, total_amount, discount_amount, tax_amount, final_amount, payment_method, notes, sale_date) VALUES
  ('40000000-0000-0000-0000-000000000001', 'SAL-2026-0001', '10000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', NULL, 899.99, 50.00, 67.50, 917.49, 'Credit Card', 'Customer requested delivery', NOW() - INTERVAL '15 days'),
  ('40000000-0000-0000-0000-000000000002', 'SAL-2026-0002', '10000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000002', NULL, 1799.99, 0.00, 135.00, 1934.99, 'Cash', NULL, NOW() - INTERVAL '12 days'),
  ('40000000-0000-0000-0000-000000000003', 'SAL-2026-0003', '10000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000003', NULL, 699.99, 20.00, 54.00, 733.99, 'Debit Card', NULL, NOW() - INTERVAL '10 days'),
  ('40000000-0000-0000-0000-000000000004', 'SAL-2026-0004', '10000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000004', NULL, 449.98, 10.00, 34.80, 474.78, 'Credit Card', NULL, NOW() - INTERVAL '8 days'),
  ('40000000-0000-0000-0000-000000000005', 'SAL-2026-0005', '10000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000005', NULL, 399.99, 0.00, 30.00, 429.99, 'Cash', NULL, NOW() - INTERVAL '5 days'),
  ('40000000-0000-0000-0000-000000000006', 'SAL-2026-0006', '10000000-0000-0000-0000-000000000003', '30000000-0000-0000-0000-000000000006', NULL, 899.99, 100.00, 63.00, 862.99, 'Credit Card', 'Holiday discount applied', NOW() - INTERVAL '4 days'),
  ('40000000-0000-0000-0000-000000000007', 'SAL-2026-0007', '10000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000007', NULL, 349.99, 0.00, 26.25, 376.24, 'Cash', NULL, NOW() - INTERVAL '3 days'),
  ('40000000-0000-0000-0000-000000000008', 'SAL-2026-0008', '10000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000008', NULL, 179.99, 0.00, 13.50, 193.49, 'Debit Card', NULL, NOW() - INTERVAL '2 days'),
  ('40000000-0000-0000-0000-000000000009', 'SAL-2026-0009', '10000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000009', NULL, 99.99, 0.00, 7.50, 107.49, 'Credit Card', NULL, NOW() - INTERVAL '1 day'),
  ('40000000-0000-0000-0000-000000000010', 'SAL-2026-0010', '10000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000010', NULL, 1799.99, 50.00, 131.25, 1881.24, 'Cash', 'VIP customer discount', NOW())
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.accounts (transaction_type, category, amount, description, reference_id, shop_id, user_id, transaction_date) VALUES
  ('income', 'Sales', 917.49, 'Sale SAL-2026-0001', '40000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', NULL, CURRENT_DATE - INTERVAL '15 days'),
  ('income', 'Sales', 1934.99, 'Sale SAL-2026-0002', '40000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', NULL, CURRENT_DATE - INTERVAL '12 days'),
  ('income', 'Sales', 733.99, 'Sale SAL-2026-0003', '40000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000002', NULL, CURRENT_DATE - INTERVAL '10 days'),
  ('expense', 'Utilities', 250.00, 'Monthly electricity bill - Main Store', NULL, '10000000-0000-0000-0000-000000000001', NULL, CURRENT_DATE - INTERVAL '9 days'),
  ('expense', 'Rent', 2500.00, 'Monthly rent - Main Store', NULL, '10000000-0000-0000-0000-000000000001', NULL, CURRENT_DATE - INTERVAL '8 days'),
  ('income', 'Sales', 474.78, 'Sale SAL-2026-0004', '40000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000001', NULL, CURRENT_DATE - INTERVAL '8 days'),
  ('income', 'Sales', 429.99, 'Sale SAL-2026-0005', '40000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000002', NULL, CURRENT_DATE - INTERVAL '5 days'),
  ('expense', 'Rent', 1800.00, 'Monthly rent - Branch Store', NULL, '10000000-0000-0000-0000-000000000002', NULL, CURRENT_DATE - INTERVAL '4 days'),
  ('income', 'Sales', 862.99, 'Sale SAL-2026-0006', '40000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000003', NULL, CURRENT_DATE - INTERVAL '4 days'),
  ('income', 'Sales', 376.24, 'Sale SAL-2026-0007', '40000000-0000-0000-0000-000000000007', '10000000-0000-0000-0000-000000000001', NULL, CURRENT_DATE - INTERVAL '3 days'),
  ('expense', 'Utilities', 180.00, 'Monthly electricity bill - Branch Store', NULL, '10000000-0000-0000-0000-000000000002', NULL, CURRENT_DATE - INTERVAL '3 days'),
  ('expense', 'Marketing', 500.00, 'Social media advertising campaign', NULL, '10000000-0000-0000-0000-000000000001', NULL, CURRENT_DATE - INTERVAL '2 days'),
  ('income', 'Sales', 193.49, 'Sale SAL-2026-0008', '40000000-0000-0000-0000-000000000008', '10000000-0000-0000-0000-000000000002', NULL, CURRENT_DATE - INTERVAL '2 days'),
  ('expense', 'Supplies', 150.00, 'Office supplies and packaging materials', NULL, '10000000-0000-0000-0000-000000000001', NULL, CURRENT_DATE - INTERVAL '1 day'),
  ('income', 'Sales', 107.49, 'Sale SAL-2026-0009', '40000000-0000-0000-0000-000000000009', '10000000-0000-0000-0000-000000000001', NULL, CURRENT_DATE - INTERVAL '1 day'),
  ('expense', 'Utilities', 120.00, 'Monthly electricity bill - Outlet Store', NULL, '10000000-0000-0000-0000-000000000003', NULL, CURRENT_DATE),
  ('income', 'Sales', 1881.24, 'Sale SAL-2026-0010', '40000000-0000-0000-0000-000000000010', '10000000-0000-0000-0000-000000000001', NULL, CURRENT_DATE),
  ('expense', 'Maintenance', 300.00, 'Store maintenance and repairs', NULL, '10000000-0000-0000-0000-000000000001', NULL, CURRENT_DATE)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.stock_transfers (id, transfer_number, from_shop_id, to_shop_id, product_id, quantity, serial_numbers, status, requested_by, approved_by, notes, requested_at, completed_at) VALUES
  ('60000000-0000-0000-0000-000000000001', 'STK-2026-0001', '10000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000001', 2, ARRAY['SN002', 'SN003'], 'completed', NULL, NULL, 'Stock transfer to meet branch demand', NOW() - INTERVAL '10 days', NOW() - INTERVAL '8 days'),
  ('60000000-0000-0000-0000-000000000002', 'STK-2026-0002', '10000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000008', 3, ARRAY['SN402', 'SN403', 'SN404'], 'completed', NULL, NULL, 'New outlet store opening inventory', NOW() - INTERVAL '7 days', NOW() - INTERVAL '6 days'),
  ('60000000-0000-0000-0000-000000000003', 'STK-2026-0003', '10000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000004', 20, NULL, 'completed', NULL, NULL, 'Accessories restock', NOW() - INTERVAL '5 days', NOW() - INTERVAL '4 days'),
  ('60000000-0000-0000-0000-000000000004', 'STK-2026-0004', '10000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000006', 2, ARRAY['SN304', 'SN305'], 'in_transit', NULL, NULL, 'Transfer for promotional event', NOW() - INTERVAL '2 days', NULL),
  ('60000000-0000-0000-0000-000000000005', 'STK-2026-0005', '10000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000009', 3, ARRAY['SN503', 'SN504', 'SN505'], 'pending', NULL, NULL, 'Return excess inventory', NOW() - INTERVAL '1 day', NULL),
  ('60000000-0000-0000-0000-000000000006', 'STK-2026-0006', '10000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000007', 5, NULL, 'completed', NULL, NULL, 'Remote control stock balancing', NOW() - INTERVAL '6 days', NOW() - INTERVAL '5 days'),
  ('60000000-0000-0000-0000-000000000007', 'STK-2026-0007', '10000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000015', 2, ARRAY['SN802', 'SN803'], 'pending', NULL, NULL, 'Apple TV for display units', NOW(), NULL)
ON CONFLICT (id) DO NOTHING;
